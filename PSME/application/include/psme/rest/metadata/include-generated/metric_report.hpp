#ifndef PSME_REST_METADATA_METRIC_REPORT_HPP
#define PSME_REST_METADATA_METRIC_REPORT_HPP
...
static const std::string MetricReport_XML =
...
<edmx:Edmx xmlns:edmx="http://docs.oasis-open.org/odata/ns/edmx" Version="4.0">
  ...
  <edmx:Reference Uri="/redfish/v1/metadata/MetricReportDefinition.xml">
  ...
  <edmx:Reference Uri="/redfish/v1/metadata/Metric.xml">
  ...
  <edmx:DataServices>
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="MetricReport.v1_0_0">
      <ComplexType Name="MetricValue">
        ...
        <NavigationProperty Name="MetricDefinition" Type="MetricDefinition.MetricDefinition">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
      ...
      <EntityType Name="MetricReport" BaseType="MetricReport.MetricReport">
        <NavigationProperty Name="MetricReportDefinition" Type="MetricReportDefinition.v1_0_0.MetricReportDefinition"
                            Nullable="false">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description" String="The metric definitions for this metric."/>
          <Annotation Term="OData.LongDescription"
...
#endif /* PSME_REST_METADATA_METRIC_REPORT_HPP */
