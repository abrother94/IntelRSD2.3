#ifndef PSME_REST_METADATA_STORAGE_REPLICA_INFO_HPP
#define PSME_REST_METADATA_STORAGE_REPLICA_INFO_HPP
...
static const std::string StorageReplicaInfo_XML =
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="StorageReplicaInfo.v1_0_0">
      ...
      <ComplexType Name="ReplicaInfo">
        ...
        <Property Name="ReplicaPriority" Type="StorageReplicaInfo.v1_0_0.ReplicaPriority">
          ...
          <Annotation Term="OData.Description" String="The priority of background copy engine I/O to be managed relative to host IO operations during a sequential background copy operation."/>
          <Annotation Term="OData.LongDescription" String="The enumeration literal shall specify the priority of background copy engine IO to be managed relative to host IO operations during a sequential background copy operation."/>
        </Property>
        <Property Name="ReplicaReadOnlyAccess" Type="StorageReplicaInfo.v1_0_0.ReplicaReadOnlyAccess">
          ...
          <Annotation Term="OData.LongDescription" String="The enumeration literal shall specify whether the source, target, or both elements are read only by the host."/>
        </Property>
        <Property Name="UndiscoveredElement" Type="StorageReplicaInfo.v1_0_0.UndiscoveredElement">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description" String="This property specifies whether the source, target, or both elements involved in a copy operation are undiscovered."/>
          <Annotation
            Term="OData.LongDescription"
            String="The enumeration literal shall specify whether the source, target, or both elements involved in a copy operation are undiscovered. An element is considered undiscovered if its object model is not known to the service performing the copy operation."/>
        </Property>
        ...
        <Property Name="ReplicaUpdateMode" Type="StorageReplicaInfo.v1_0_0.ReplicaUpdateMode">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          ...
          <Annotation Term="OData.LongDescription" String="The enumeration literal shall specify whether the target elements update synchronously or asynchronously."/>
        </Property>
        ...
        <Property Name="ReplicaType" Type="StorageReplicaInfo.v1_0_0.ReplicaType">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
        ...
        <NavigationProperty Name="Replica" Type="Resource.v1_0_0.Resource">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description" String="The resource that is the source of this replica."/>
          <Annotation Term="OData.LongDescription" String="The value shall reference the resource that is the source of the replica."/>
...
#endif /* PSME_REST_METADATA_STORAGE_REPLICA_INFO_HPP */
