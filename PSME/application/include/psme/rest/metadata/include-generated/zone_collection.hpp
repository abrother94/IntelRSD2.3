#ifndef PSME_REST_METADATA_ZONE_COLLECTION_HPP
#define PSME_REST_METADATA_ZONE_COLLECTION_HPP
...
static const std::string ZoneCollection_XML =
  ...
  <edmx:DataServices>
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="ZoneCollection">
      ...
      <EntityType Name="ZoneCollection" BaseType="Resource.v1_0_0.ResourceCollection">
        ...
        <NavigationProperty Name="Members" Type="Collection(Zone.Zone)" Nullable="false">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description" String="Collection of zones."/>
          <Annotation Term="OData.LongDescription" String="Collection of zones."/>
...
#endif /* PSME_REST_METADATA_ZONE_COLLECTION_HPP */
