#ifndef PSME_REST_METADATA_P_CIE_DEVICE_HPP
#define PSME_REST_METADATA_P_CIE_DEVICE_HPP
...
static const std::string PCIeDevice_XML =
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="PCIeDevice">
      ...
      <EntityType Name="PCIeDevice" BaseType="Resource.v1_0_0.Resource">
        <Annotation Term="OData.Description"
                    String="This is the schema definition for the PCIeDevice resource.  It represents the properties of a PCIeDevice attached to a System."/>
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="PCIeDevice.v1_0_0">
      ...
      <EntityType Name="PCIeDevice" BaseType="PCIeDevice.PCIeDevice">
        ...
        <Property Name="Manufacturer" Type="Edm.String">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be the name of the organization responsible for producing the PCIe device. This organization might be the entity from whom the PCIe device is purchased, but this is not necessarily true."/>
        </Property>
        <Property Name="Model" Type="Edm.String">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description" String="This is the model number for the PCIe device."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be the name by which the manufacturer generally refers to the PCIe device."/>
        </Property>
        <Property Name="SKU" Type="Edm.String">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description" String="This is the SKU for this PCIe device."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be the stock-keeping unit number for this PCIe device."/>
        </Property>
        <Property Name="SerialNumber" Type="Edm.String">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description" String="The serial number for this PCIe device."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be a manufacturer-allocated number used to identify the PCIe device."/>
        </Property>
        <Property Name="PartNumber" Type="Edm.String">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description" String="The part number for this PCIe device."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be a part number assigned by the organization that is responsible for producing or manufacturing the PCIe device."/>
        </Property>
        <Property Name="AssetTag" Type="Edm.String">
          <Annotation Term="OData.Description" String="The user assigned asset tag for this PCIe device."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be an identifying string used to track the PCIe device for inventory purposes."/>
        </Property>
        ...
        <Property Name="DeviceType" Type="PCIeDevice.v1_0_0.DeviceType" Nullable="false">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be the device type of the PCIe device such as SingleFunction or MultiFunction."/>
        </Property>
        <Property Name="FirmwareVersion" Type="Edm.String">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description" String="The version of firmware for this PCIe device."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be the firmware version of the PCIe device."/>
        </Property>
      ...
      <ComplexType Name="Links" BaseType="Resource.Links">
        <NavigationProperty Name="Chassis" Type="Collection(Chassis.Chassis)">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description"
                      String="An array of references to the chassis in which the PCIe device is contained"/>
          <Annotation Term="OData.LongDescription"
        ...
        <NavigationProperty Name="PCIeFunctions" Type="Collection(PCIeFunction.PCIeFunction)">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description"
                      String="An array of references to PCIeFunctions exposed by this device."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be a reference to the resources that this device exposes and shall reference a resource of type PCIeFunction."/>
          <Annotation Term="OData.AutoExpandReferences"/>
        </NavigationProperty>
      </ComplexType>
      <EnumType Name="DeviceType">
        ...
        <Member Name="Simulated">
          <Annotation Term="OData.Description"
                      String="A PCIe device which is not currently physically present, but is being simulated by the PCIe infrastructure"/>
        </Member>
      </EnumType>
...
#endif /* PSME_REST_METADATA_P_CIE_DEVICE_HPP */
