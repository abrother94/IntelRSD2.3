#ifndef PSME_REST_METADATA_SCHEDULE_HPP
#define PSME_REST_METADATA_SCHEDULE_HPP
...
static const std::string Schedule_XML =
      ...
      <ComplexType Name="Schedule" BaseType="Schedule.Schedule">
        ...
        <Property Name="Name" Type="Edm.String">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The name of the Schedule. It should be constructed as OrgID:ScheduleName. Examples: ACME:Daily, ACME:Weekly, ACME:FirstTuesday."/>
        </Property>
        <Property Name="Lifetime" Type="Edm.String">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value shall be an ISO 8601 conformant duration describing the time after provisioning when the schedule expires."/>
        </Property>
        ...
        <Property Name="InitialStartTime" Type="Edm.String">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value shall be an ISO 8601 conformant time of day on which the initial occurrence is scheduled to occur."/>
        </Property>
        <Property Name="RecurrenceInterval" Type="Edm.String">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value shall be an ISO 8601 conformant duration describing the time until the next occurrence."/>
        </Property>
        <Property Name="EnabledDaysOfWeek" Type="Collection(Schedule.v1_0_0.DayOfWeek)">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/ReadWrite"/>
          <Annotation Term="OData.Description"
                      String="Days of the week when scheduled occurrences are enabled, for enabled days of month and months of year."/>
          <Annotation Term="OData.LongDescription"
                      String="Days of the week when scheduled occurrences are enabled. If not present, all days of the week shall be enabled."/>
        </Property>
        <Property Name="EnabledDaysOfMonth" Type="Collection(Edm.Int64)">
          ...
          <Annotation Term="OData.LongDescription"
                      String="Days of month when scheduled occurrences are enabled, for enabled days of week and months of year. If not present, all days of the month shall be enabled."/>
        ...
        <Property Name="EnabledMonthsOfYear" Type="Collection(Schedule.v1_0_0.MonthOfYear)">
          ...
          <Annotation Term="OData.LongDescription"
                      String="Months of year when scheduled occurrences are enabled, for enabled days of week and days of month. If not present, all months of the year shall be enabled."/>
        </Property>
      </ComplexType>
...
#endif /* PSME_REST_METADATA_SCHEDULE_HPP */
