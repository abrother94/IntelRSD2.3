#ifndef PSME_REST_METADATA_SETTINGS_HPP
#define PSME_REST_METADATA_SETTINGS_HPP
...
static const std::string Settings_XML =
      ...
      <ComplexType Name="Settings" BaseType="Settings.Settings">
        ...
        <Property Name="Time" Type="Edm.DateTimeOffset">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall indicate the time that the settings object was applied to the resource."/>
        </Property>
        <Property Name="ETag" Type="Edm.String">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be the ETag of the resource to which the settings were applied, after the application.  This is here so that the client can check it against the ETag of the current resource to see if any other changes have also happened to the resource."/>
        </Property>
        <NavigationProperty Name="SettingsObject" Type="Resource.Item" Nullable="false">
          <Annotation Term="OData.Description"
                      String="Reference to the resource the client may PUT/PATCH to in order to change this resource."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be the URI of the resource to which a client must do a PUT or PATCh in order to modify this resource."/>
        ...
        <Property Name="Messages" Type="Collection(Message.Message)" Nullable="false">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be an array of messages associated with the task."/>
        </Property>
      </ComplexType>
...
#endif /* PSME_REST_METADATA_SETTINGS_HPP */
