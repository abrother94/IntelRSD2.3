#ifndef PSME_REST_METADATA_CHASSIS_COLLECTION_HPP
#define PSME_REST_METADATA_CHASSIS_COLLECTION_HPP
...
static const std::string ChassisCollection_XML =
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="ChassisCollection">
      ...
      <EntityType Name="ChassisCollection" BaseType="Resource.v1_0_0.ResourceCollection">
        <NavigationProperty Name="Members" Type="Collection(Chassis.Chassis)" Nullable="false">
          ...
          <Annotation Term="OData.Description" String="Collection of Chassis"/>
          <Annotation Term="OData.LongDescription" String="Collection of Chassis"/>
...
#endif /* PSME_REST_METADATA_CHASSIS_COLLECTION_HPP */
