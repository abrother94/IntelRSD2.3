#ifndef PSME_REST_METADATA_PORT_COLLECTION_HPP
#define PSME_REST_METADATA_PORT_COLLECTION_HPP
...
static const std::string PortCollection_XML =
  ...
  <edmx:DataServices>
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="PortCollection">
      ...
      <EntityType Name="PortCollection" BaseType="Resource.v1_0_0.ResourceCollection">
        ...
        <NavigationProperty Name="Members" Type="Collection(Port.Port)" Nullable="false">
...
#endif /* PSME_REST_METADATA_PORT_COLLECTION_HPP */
