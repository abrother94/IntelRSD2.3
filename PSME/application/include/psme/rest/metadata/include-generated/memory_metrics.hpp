#ifndef PSME_REST_METADATA_MEMORY_METRICS_HPP
#define PSME_REST_METADATA_MEMORY_METRICS_HPP
...
static const std::string MemoryMetrics_XML =
R"Xy+Z*aF--(<?xml version="1.0" encoding="UTF-8"?>
<!---->
<!--################################################################################       -->
<!--# Redfish Schema:  MemoryMetrics  v1.1.0-->
<!--#                                                                                      -->
...
<edmx:Edmx xmlns:edmx="http://docs.oasis-open.org/odata/ns/edmx" Version="4.0">
  ...
  <edmx:DataServices>
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="MemoryMetrics">
      ...
      <EntityType Name="MemoryMetrics" BaseType="Resource.v1_0_0.Resource" Abstract="true">
        <Annotation Term="OData.Description"
                    String="MemoryMetrics contains usage and health statistics for a single Memory module or device instance."/>
        <Annotation Term="OData.LongDescription"
                    String="This resource shall be used to represent the Memory Metrics for a single Memory device in a Redfish implementation."/>
      ...
      <Action Name="ClearCurrentPeriod" IsBound="true">
        ...
        <Annotation Term="OData.LongDescription"
                    String="This action shall set the CurrentPeriod object property values to zero."/>
      </Action>
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="MemoryMetrics.v1_0_0">
      ...
      <EntityType Name="MemoryMetrics" BaseType="MemoryMetrics.MemoryMetrics">
        <Property Name="BlockSizeBytes" Type="Edm.Int64">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be the block size in bytes of all stucture elements."/>
          <Annotation Term="Measures.Unit" String="By"/>
        </Property>
        <Property Name="CurrentPeriod" Type="MemoryMetrics.v1_0_0.CurrentPeriod" Nullable="false">
          <Annotation Term="OData.Description"
                      String="This object contains the Memory metrics since last reset or ClearCurrentPeriod action."/>
          <Annotation Term="OData.LongDescription"
        ...
        <Property Name="LifeTime" Type="MemoryMetrics.v1_0_0.LifeTime" Nullable="false">
          <Annotation Term="OData.Description"
                      String="This object contains the Memory metrics for the lifetime of the Memory."/>
          <Annotation Term="OData.LongDescription"
      ...
      <ComplexType Name="CurrentPeriod">
        ...
        <Property Name="BlocksRead" Type="Edm.Int64">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be number of blocks read since reset."/>
        </Property>
        <Property Name="BlocksWritten" Type="Edm.Int64">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description" String="Number of blocks written since reset."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be mumber of blocks written since reset."/>
        </Property>
        <Annotation Term="OData.Description"
                    String="This object contains the Memory metrics since last reset or ClearCurrentPeriod action."/>
        <Annotation Term="OData.LongDescription"
                    String="This type shall describe the metrics of the memory since last time the ClearCurrentPeriod Action was performed or the system reset."/>
      </ComplexType>
      ...
      <ComplexType Name="LifeTime">
        ...
        <Property Name="BlocksRead" Type="Edm.Int64">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be number of blocks read for the lifetime of the Memory."/>
        </Property>
        <Property Name="BlocksWritten" Type="Edm.Int64">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description" String="Number of blocks written for the lifetime of the Memory."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be number of blocks written for the lifetime of the Memory."/>
        </Property>
        <Annotation Term="OData.Description"
                    String="This object contains the Memory metrics for the lifetime of the Memory."/>
        <Annotation Term="OData.LongDescription"
      ...
      <ComplexType Name="HealthData">
        ...
        <Property Name="RemainingSpareBlockPercentage" Type="Edm.Decimal">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be the remaining spare blocks in percentage."/>
        </Property>
        <Property Name="LastShutdownSuccess" Type="Edm.Boolean">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description" String="Status of last shutdown."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be the status ofthe  last shutdown, with true indicating success."/>
        </Property>
        <Property Name="DataLossDetected" Type="Edm.Boolean">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description" String="Data loss detection status."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be data loss detection status, with true indicating data loss detected."/>
        </Property>
        <Property Name="PerformanceDegraded" Type="Edm.Boolean">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be performance degraded mode status, with true indicating perfomance degraded."/>
        </Property>
        <Property Name="AlarmTrips" Type="MemoryMetrics.v1_0_0.AlarmTrips" Nullable="false">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This object shall contain properties describe the types of alarms that have been raised by the memory."/>
        </Property>
      </ComplexType>
      ...
      <ComplexType Name="AlarmTrips">
        ...
        <Annotation Term="OData.Description" String="Alarm trip information about the memory."/>
        <Annotation Term="OData.LongDescription"
                    String="This type shall contain properties describing the types of alarms that have been raised by the memory."/>
        <Property Name="Temperature" Type="Edm.Boolean">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be true if a temperature threshold alarm trip was detected."/>
        </Property>
        <Property Name="SpareBlock" Type="Edm.Boolean">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be true if the spare block capacity crossing alarm trip was detected."/>
        </Property>
        <Property Name="UncorrectableECCError" Type="Edm.Boolean">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description"
                      String="Uncorrectable data error threshold crossing alarm trip detected status."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be true if the uncorrectable error threshold alarm trip was detected."/>
        </Property>
        <Property Name="CorrectableECCError" Type="Edm.Boolean">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description"
                      String="Correctable data error threshold crossing alarm trip detected status."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be true if the correctable error threshold crossing alarm trip was detected."/>
        </Property>
        <Property Name="AddressParityError" Type="Edm.Boolean">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be true if an Address Parity Error was detected which could not be corrected by retry."/>
        </Property>
      </ComplexType>
      ...
      <ComplexType Name="Actions">
        ...
        <Annotation Term="OData.Description" String="The available actions for this resource."/>
        <Annotation Term="OData.LongDescription"
                    String="This type shall contain the available actions for this resource."/>
      ...
      <ComplexType Name="OemActions">
        ...
        <Annotation Term="OData.LongDescription"
                    String="This type shall contain any additional OEM actions for this resource."/>
      </ComplexType>
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="MemoryMetrics.v1_0_2">
      <Annotation Term="OData.Description"
                  String="This version was created to show BlocksWritten in CurrentPeriod and LifeTime ComplexTypes, and annotations in previous namespaces were updated."/>
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="MemoryMetrics.v1_1_0">
      ...
      <ComplexType Name="HealthData" BaseType="MemoryMetrics.v1_0_0.HealthData">
        <Property Name="PredictedMediaLifeLeftPercent" Type="Edm.Decimal">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This property shall contain an indicator of the percentage of life remaining in the media."/>
        </Property>
      </ComplexType>
    </Schema>
...
#endif /* PSME_REST_METADATA_MEMORY_METRICS_HPP */
