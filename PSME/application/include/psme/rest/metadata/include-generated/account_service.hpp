#ifndef PSME_REST_METADATA_ACCOUNT_SERVICE_HPP
#define PSME_REST_METADATA_ACCOUNT_SERVICE_HPP
...
static const std::string AccountService_XML =
...
<edmx:Edmx xmlns:edmx="http://docs.oasis-open.org/odata/ns/edmx" Version="4.0">
  ...
  <edmx:Reference Uri="/redfish/v1/metadata/ManagerAccountCollection.xml">
    <edmx:Include Namespace="ManagerAccountCollection"/>
  </edmx:Reference>
  <edmx:Reference Uri="/redfish/v1/metadata/RoleCollection.xml">
  ...
  <edmx:DataServices>
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="AccountService">
      <EntityType Name="AccountService" BaseType="Resource.v1_0_0.Resource">
        <Annotation Term="OData.Description"
                    String="This is the schema definition for the Account Service.  It represents the properties for the service itself and has links to the actual list of accounts."/>
        <Annotation Term="OData.LongDescription"
                    String="This resource shall be used to represent a management account service for a Redfish implementation."/>
      </EntityType>
    </Schema>
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="AccountService.v1_0_0">
      ...
      <EntityType Name="AccountService" BaseType="AccountService.AccountService">
        ...
        <Property Name="AuthFailureLoggingThreshold" Type="Edm.Int64" Nullable="false">
          ...
          <Annotation Term="OData.Description"
                      String="This is the number of authorization failures that need to occur before the failure attempt is logged to the manager log."/>
          <Annotation Term="OData.LongDescription"
                      String="This property shall reference the threshold for when an authorization failure is logged.  This represents a modulo function value, thus the failure shall be logged every nth occurrence where n represents the value of this property."/>
        ...
        <Property Name="MinPasswordLength" Type="Edm.Int16" Nullable="false">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This property shall reference the minimum password length that the implementation will allow a password to be set to."/>
          <Annotation Term="Validation.Minimum" Int="0"/>
        </Property>
        <Property Name="MaxPasswordLength" Type="Edm.Int16" Nullable="false">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This property shall reference the maximum password length that the implementation will allow a password to be set to."/>
          <Annotation Term="Validation.Minimum" Int="0"/>
        </Property>
        <Property Name="AccountLockoutThreshold" Type="Edm.Int16" Nullable="true">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/ReadWrite"/>
          <Annotation Term="OData.Description"
                      String="The number of failed login attempts before a user account is locked for a specified duration. (0=never locked)"/>
          <Annotation Term="OData.LongDescription"
                      String="This property shall reference the threshold of failed login attempts at which point the user's account is locked.  If set to 0, no lockout shall ever occur."/>
          <Annotation Term="Validation.Minimum" Int="0"/>
        </Property>
        <Property Name="AccountLockoutDuration" Type="Edm.Int32" Nullable="true">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/ReadWrite"/>
          <Annotation Term="OData.Description"
                      String="The time an account is locked after the account lockout threshold is met. Must be >= AccountLockoutResetAfter. If set to 0, no lockout will occur."/>
          <Annotation Term="OData.LongDescription"
        ...
        <Property Name="AccountLockoutCounterResetAfter" Type="Edm.Int32" Nullable="false">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/ReadWrite"/>
          <Annotation Term="OData.Description"
                      String="The interval of time since the last failed login attempt at which point the lockout threshold counter for the account is reset to zero. Must be less than or equal to AccountLockoutDuration"/>
          <Annotation Term="OData.LongDescription"
        ...
        <NavigationProperty Name="Accounts" Type="ManagerAccountCollection.ManagerAccountCollection">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This property shall contain the link to a collection of type ManagerAccountCollection."/>
        ...
        <NavigationProperty Name="Roles" Type="RoleCollection.RoleCollection">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This property shall contain the link to a collection of type RoleCollection."/>
          <Annotation Term="OData.AutoExpandReferences"/>
        </NavigationProperty>
      </EntityType>
...
#endif /* PSME_REST_METADATA_ACCOUNT_SERVICE_HPP */
