#ifndef PSME_REST_METADATA_MESSAGE_REGISTRY_FILE_HPP
#define PSME_REST_METADATA_MESSAGE_REGISTRY_FILE_HPP
...
static const std::string MessageRegistryFile_XML =
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="MessageRegistryFile.v1_0_0">
      ...
      <EntityType Name="MessageRegistryFile" BaseType="MessageRegistryFile.MessageRegistryFile">
        ...
        <Property Name="Registry" Type="Edm.String" Nullable="false">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description"
                      String="The Registry Name, Major and Minor version used in MessageID construction."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be the value of the Registry Name, Major and Minor version and shall conform to the syntax specified in the Redfish specification for the MessageId property without the MessageKey."/>
          <Annotation Term="Redfish.Required"/>
        </Property>
      ...
      <ComplexType Name="Location">
        ...
        <Property Name="Uri" Type="Edm.String" Nullable="false">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be a URI co-located with the Redfish service that specifies the location of the schema file.  This property shall only be used for individual schema files.  The file name portion of the URI shall conform to the syntax specified in the Redfish specification."/>
        ...
        <Property Name="ArchiveFile" Type="Edm.String" Nullable="false">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be the file name of the individual schema file within the archive file specified by the ArchiveUri property. The file name shall conform to the syntax specified in the Redfish specification."/>
        </Property>
      </ComplexType>
...
#endif /* PSME_REST_METADATA_MESSAGE_REGISTRY_FILE_HPP */
