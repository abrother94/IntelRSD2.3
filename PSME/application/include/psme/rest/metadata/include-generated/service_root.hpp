#ifndef PSME_REST_METADATA_SERVICE_ROOT_HPP
#define PSME_REST_METADATA_SERVICE_ROOT_HPP
...
static const std::string ServiceRoot_XML =
...
<edmx:Edmx xmlns:edmx="http://docs.oasis-open.org/odata/ns/edmx" Version="4.0">
  ...
  <edmx:Reference Uri="/redfish/v1/metadata/UpdateService.xml">
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="ServiceRoot">
      ...
      <EntityType Name="ServiceRoot" BaseType="Resource.v1_0_0.Resource" Abstract="true">
        ...
        <Annotation Term="OData.LongDescription"
                    String="This object represents the root Redfish service.  All values for resources described by this schema shall comply with the requirements as described in the Redfish specification."/>
      </EntityType>
    </Schema>
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="ServiceRoot.v1_0_0">
      ...
      <EntityType Name="ServiceRoot" BaseType="ServiceRoot.ServiceRoot">
        ...
        <Property Name="RedfishVersion" Type="Edm.String" Nullable="false">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value of the string shall represent the version of the Redfish service. The format of this string shall be of the format majorversion.minorversion.errata in compliance with the Protocol Version section of the Redfish specification."/>
        ...
        <NavigationProperty Name="Systems" Type="ComputerSystemCollection.ComputerSystemCollection" Nullable="false">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This object shall only contain a reference to a collection of resources that comply with the Systems schema."/>
        ...
        <NavigationProperty Name="Chassis" Type="ChassisCollection.ChassisCollection" Nullable="false">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This object shall only contain a reference to a collection of resources that comply with the Chassis schema."/>
          <Annotation Term="OData.AutoExpandReferences"/>
        </NavigationProperty>
        <NavigationProperty Name="Managers" Type="ManagerCollection.ManagerCollection" Nullable="false">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This object shall only contain a reference to a collection of resources that comply with the Managers schema."/>
          <Annotation Term="OData.AutoExpandReferences"/>
        </NavigationProperty>
        <NavigationProperty Name="Tasks" Type="TaskService.TaskService" Nullable="false">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The classes' structure shall only contain a reference to a resource that complies with the TaskService schema."/>
          <Annotation Term="OData.AutoExpandReferences"/>
        </NavigationProperty>
        <NavigationProperty Name="SessionService" Type="SessionService.SessionService" Nullable="false">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The classes' structure shall only contain a reference to a resource that complies with the SessionService schema."/>
          <Annotation Term="OData.AutoExpandReferences"/>
        </NavigationProperty>
        <NavigationProperty Name="AccountService" Type="AccountService.AccountService" Nullable="false">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The classes' structure shall only contain a reference to a resource that complies with the AccountService schema."/>
          <Annotation Term="OData.AutoExpandReferences"/>
        </NavigationProperty>
        <NavigationProperty Name="EventService" Type="EventService.EventService" Nullable="false">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The classes' structure shall only contain a reference to a resource that complies with the EventService schema."/>
          <Annotation Term="OData.AutoExpandReferences"/>
        </NavigationProperty>
        <NavigationProperty Name="Registries" Type="MessageRegistryFileCollection.MessageRegistryFileCollection"
          ...
          <Annotation Term="OData.LongDescription" String="This object shall contain a reference to the Message Registry."/>
          <Annotation Term="OData.AutoExpandReferences"/>
        </NavigationProperty>
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="ServiceRoot.v1_1_0">
      <EntityType Name="ServiceRoot" BaseType="ServiceRoot.v1_0_2.ServiceRoot">
        ...
        <NavigationProperty Name="UpdateService" Type="UpdateService.UpdateService" Nullable="false">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The classes' structure shall only contain a reference to a resource that complies with the UpdateService schema." />
          <Annotation Term="OData.AutoExpandReferences" />
        </NavigationProperty>
      </EntityType>
    </Schema>
...
#endif /* PSME_REST_METADATA_SERVICE_ROOT_HPP */
