#ifndef PSME_REST_METADATA_SIMPLE_STORAGE_COLLECTION_HPP
#define PSME_REST_METADATA_SIMPLE_STORAGE_COLLECTION_HPP
...
static const std::string SimpleStorageCollection_XML =
...
<edmx:Edmx xmlns:edmx="http://docs.oasis-open.org/odata/ns/edmx" Version="4.0">
  ...
  <edmx:Reference Uri="/redfish/v1/metadata/SimpleStorage.xml">
  ...
  <edmx:DataServices>
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="SimpleStorageCollection">
      ...
      <EntityType Name="SimpleStorageCollection" BaseType="Resource.v1_0_0.ResourceCollection">
        ...
        <NavigationProperty Name="Members" Type="Collection(SimpleStorage.SimpleStorage)" Nullable="false">
...
#endif /* PSME_REST_METADATA_SIMPLE_STORAGE_COLLECTION_HPP */
