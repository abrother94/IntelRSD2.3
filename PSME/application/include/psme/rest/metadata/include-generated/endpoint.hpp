#ifndef PSME_REST_METADATA_ENDPOINT_HPP
#define PSME_REST_METADATA_ENDPOINT_HPP
...
static const std::string Endpoint_XML =
...
<edmx:Edmx xmlns:edmx="http://docs.oasis-open.org/odata/ns/edmx" Version="4.0">
  ...
  <edmx:Reference Uri="/redfish/v1/metadata/IPAddresses.xml">
    <edmx:Include Namespace="IPAddresses.v1_0_0" Alias="IPAddresses"/>
  </edmx:Reference>
  ...
  <edmx:Reference Uri="/redfish/v1/metadata/NetworkDeviceFunction.xml">
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="Endpoint.v1_0_0">
      ...
      <EntityType Name="Endpoint" BaseType="Endpoint.Endpoint">
        <Annotation Term="OData.Description"
                    String="This is the schema definition for the Endpoint resource. It represents the properties of an entity that sends or receives protocol defined messages over a transport."/>
        <Annotation Term="OData.LongDescription"
                    String="This resource shall be used to represent a fabric endpoint for a Redfish implementation."/>
        ...
        <Property Name="EndpointProtocol" Type="Protocol.Protocol">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description" String="The protocol supported by the endpoint."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of the property contains the protocol the endpoint uses to communicate with other endpoints on the fabric."/>
        </Property>
        <Property Name="ConnectedEntities" Type="Collection(Endpoint.v1_0_0.ConnectedEntity)">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description" String="All the entities connected to the endpoint."/>
          <Annotation Term="OData.LongDescription"
                      String="This value of the property contains all the entities that the endpoint allows access to."/>
        </Property>
        <Property Name="Identifiers" Type="Collection(Resource.v1_1_0.Identifier)">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description" String="Identifiers for the endpoint."/>
          <Annotation Term="OData.LongDescription"
                      String="Identifiers for the endpoint shall be unique in the context of other endpoints that can be reached over connected network."/>
        </Property>
        ...
        <Property Name="PciId" Type="Endpoint.v1_0_0.PciId">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value of the property is the PCI ID of the endpoint."/>
        </Property>
        <NavigationProperty Name="Redundancy" Type="Collection(Redundancy.Redundancy)">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description"
                      String="Redundancy information for the lower-level endpoints supporting this endpoint."/>
          <Annotation Term="OData.LongDescription"
                      String="Redundancy information for the lower-level endpoints supporting this endpoint."/>
        ...
        <Property Name="HostReservationMemoryBytes" Type="Edm.Int64">
          ...
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description"
                      String="The amount of memory in Bytes that the host should allocate to connect to the endpoint."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of the property is the amount of memory in Bytes that the host should allocate to connect to the endpoint."/>
        </Property>
        ...
        <Property Name="Actions" Type="Endpoint.v1_0_0.Actions" Nullable="false">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description"
                      String="Actions available for the resource."/>
          <Annotation Term="OData.LongDescription"
                      String="Actions available for the resource."/>
        </Property>
      </EntityType>
      ...
      <ComplexType Name="Links" BaseType="Resource.Links">
        ...
        <NavigationProperty Name="MutuallyExclusiveEndpoints" Type="Collection(Endpoint.Endpoint)">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description"
                      String="An array of references to the endpoints that may not be used in zones if this endpoint is used in a zone."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be an array of references of type Endpoint that cannot be used in a zone if this endpoint is used in a zone."/>
          <Annotation Term="OData.AutoExpandReferences"/>
        </NavigationProperty>
        <NavigationProperty Name="Ports" Type="Collection(Port.Port)">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description"
                      String="An array of references to the the physical ports associated with this endpoint."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be an array of references of type Port that are utilized by this endpoint."/>
          <Annotation Term="OData.AutoExpandReferences"/>
        </NavigationProperty>
      </ComplexType>
      ...
      <ComplexType Name="ConnectedEntity">
        ...
        <Property Name="EntityType" Type="Endpoint.v1_0_0.EntityType">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value of the property indicates the type of connected entity."/>
        </Property>
        <Property Name="EntityRole" Type="Endpoint.v1_0_0.EntityRole">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value of the property indicates if the specified entity is an initiator, target, or both."/>
        </Property>
        <Property Name="EntityPciId" Type="Endpoint.v1_0_0.PciId">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value of the property is the PCI ID of the connected PCIe entity."/>
        </Property>
        <Property Name="PciFunctionNumber" Type="Edm.Int64">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description" String="The PCI ID of the connected entity."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of the property is the PCI Function Number of the connected PCIe entity."/>
        </Property>
        <Property Name="PciClassCode" Type="Edm.String">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description" String="The Class Code, Subclass code, and Programming Interface Code of the PCIe function."/>
          <Annotation Term="OData.LongDescription" String="The value of the property is the PCI Class Code, Subclass code, and Programming Interface Code of the PCIe device function."/>
        ...
        <Property Name="Identifiers" Type="Collection(Resource.v1_1_0.Identifier)">
          ...
          <Annotation Term="OData.LongDescription"
                      String="Identifiers for the remote entity shall be unique in the context of other resources that can be reached over the connected network."/>
        </Property>
        <NavigationProperty Name="EntityLink" Type="Resource.Resource">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This property is a reference to an entity of the type specified by the description of the value of the EntityType property."/>
        </NavigationProperty>

        <Property Name="Oem" Type="Resource.Oem">
          <Annotation Term="OData.Description" String="This property is a reference to OEM extensions."/>
          <Annotation Term="OData.LongDescription"
                      String="This property is a reference to OEM extensions."/>
        </Property>
      </ComplexType>
      ...
      <EnumType Name="EntityType">
        <Member Name="StorageInitiator">
          <Annotation Term="OData.Description"
                      String="The entity is a storage initator. The EntityLink property (if present) should be a Storage.StorageController entity"/>
        </Member>
        <Member Name="RootComplex">
          <Annotation Term="OData.Description"
                      String="The entity is a PCI(e) root complex. The EntityLink property (if present) should be a ComputerSystem.ComputerSystem entity"/>
        </Member>
        <Member Name="NetworkController">
          <Annotation Term="OData.Description"
                      String="The entity is a network controller. The EntityLink property (if present) should be an EthernetInterface.EthernetInterface entity"/>
        </Member>
        <Member Name="Drive">
          <Annotation Term="OData.Description"
                      String="The entity is a disk drive. The EntityLink property (if present) should be a Drive.Drive entity"/>
        </Member>
        <Member Name="StorageExpander">
          <Annotation Term="OData.Description"
                      String="The entity is a storage expander. The EntityLink property (if present) should be a Chassis.Chassis entity"/>
        </Member>
      ...
      <EnumType Name="EntityRole">
        <Member Name="Initiator">
          <Annotation Term="OData.Description" String="The entity acts as an initiator."/>
          <Annotation Term="OData.LongDescription" String="Indicates that the entity is acting as an initiator."/>
        </Member>
        <Member Name="Target">
          <Annotation Term="OData.Description" String="The entity acts as a target."/>
          <Annotation Term="OData.LongDescription" String="Indicates that the entity is acting as a target."/>
        </Member>
        <Member Name="Both">
          <Annotation Term="OData.Description" String="The entity acts as both an initiator and a target."/>
          <Annotation Term="OData.LongDescription" String="Indicates that the entity is acting as both an initiator and a target."/>
        </Member>
      </EnumType>
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="Endpoint.v1_1_0">
      <EntityType Name="Endpoint" BaseType="Endpoint.v1_0_3.Endpoint">
        <Property Name="IPTransportDetails" Type="Collection(Endpoint.v1_1_0.IPTransportDetails)">
          <Annotation Term="OData.Description" String="This array contains details for each IP transport supported by the endpoint. The array structure can be used to model multiple IP addresses for the endpoint."/>
          <Annotation Term="OData.LongDescription" String="This array contains the details for each IP transport supported by the endpoint."/>
        </Property>
      </EntityType>
      ...
      <ComplexType Name="Links" BaseType="Endpoint.v1_0_0.Links">
        <NavigationProperty Name="NetworkDeviceFunction" Type="Collection(NetworkDeviceFunction.NetworkDeviceFunction)">
          ...
          <Annotation Term="OData.LongDescription" String="The value of the property is a reference to a NetworkDeviceFunction resource associated with the endpoint."/>
          <Annotation Term="OData.AutoExpandReferences"/>
        </NavigationProperty>
      </ComplexType>
      ...
      <ComplexType Name="IPTransportDetails">
        ...
        <Property Name="TransportProtocol" Type="Protocol.Protocol" Nullable="false">
          ...
          <Annotation Term="OData.LongDescription" String="The value is the protocol used by the connection entity."/>
        </Property>
        <Property Name="IPv4Address" Type="IPAddresses.v1_0_0.IPv4Address" Nullable="false">
          <Annotation Term="OData.Description" String="The IPv4 addresses assigned to the Endpoint."/>
          <Annotation Term="OData.LongDescription" String="The value of the property specifies the IPv4Address."/>
        </Property>
        <Property Name="IPv6Address" Type="IPAddresses.v1_0_0.IPv6Address" Nullable="false">
          <Annotation Term="OData.Description" String="The IPv6 addresses assigned to the Endpoint."/>
          <Annotation Term="OData.LongDescription" String="The value of the property specifies the IPv6Address."/>
        </Property>
        <Property Name="Port" Type="Edm.Decimal" Nullable="false">
          ...
          <Annotation Term="OData.LongDescription" String="The value of the property specifies the UDP or TCP port number used for communication with the endpoint."/>
...
#endif /* PSME_REST_METADATA_ENDPOINT_HPP */
