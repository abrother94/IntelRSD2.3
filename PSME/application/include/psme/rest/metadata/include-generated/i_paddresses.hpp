#ifndef PSME_REST_METADATA_I_PADDRESSES_HPP
#define PSME_REST_METADATA_I_PADDRESSES_HPP
...
static const std::string IPAddresses_XML =
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="IPAddresses.v1_0_0">
      ...
      <ComplexType Name="IPv4Address" BaseType="IPAddresses.IPv4Address">
        ...
        <Property Name="Address" Type="Edm.String">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be an IPv4 address assigned to this interface.  If DHCPv4 is enabled on the interface, this property becomes read-only."/>
        ...
        <Property Name="SubnetMask" Type="IPAddresses.v1_0_0.SubnetMask">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be the IPv4 subnet mask for this address.  If DHCPv4 is enabled on the interface, this property becomes read-only."/>
        </Property>
        <Property Name="AddressOrigin" Type="IPAddresses.v1_0_0.IPv4AddressOrigin">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be the IP address origin for this network interface."/>
        </Property>
        <Property Name="Gateway" Type="Edm.String">
          <Annotation Term="OData.Description" String="This is the IPv4 gateway for this address."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be the IPv4 default gateway address for this interface. If DHCPv4 is enabled on the interface and is configured to set the IPv4 default gateway address, this property becomes read-only."/>
          <Annotation Term="Validation.Pattern" String="^(?:[0-9]{1,3}\.){3}[0-9]{1,3}$"/>
        </Property>
      </ComplexType>
      ...
      <ComplexType Name="IPv6Address" BaseType="IPAddresses.IPv6Address">
        ...
        <Property Name="Address" Type="Edm.String">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This property lists an IPv6 address that is currently assigned on this interface."/>
        ...
        <Property Name="PrefixLength" Type="IPAddresses.v1_0_0.PrefixLength">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be the IPv6 address prefix length for this interface."/>
        </Property>
        <Property Name="AddressOrigin" Type="IPAddresses.v1_0_0.IPv6AddressOrigin">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description" String="This indicates how the address was determined."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be the IPv6 address origin for this interface."/>
        </Property>
      ...
      <EnumType Name="IPv6AddressOrigin">
        ...
        <Member Name="SLAAC">
          <Annotation Term="OData.Description"
                      String="Address is provided by a Stateless Address AutoConfiguration (SLAAC) service"/>
        </Member>
      </EnumType>
      ...
      <EnumType Name="AddressState">
        <Member Name="Preferred">
          <Annotation Term="OData.Description"
                      String="This address is currently within both it's valid and preferred lifetimes as defined in RFC 4862."/>
        </Member>
        <Member Name="Deprecated">
          <Annotation Term="OData.Description"
                      String="This address is currently within it's valid lifetime, but is now outside of it's preferred lifetime as defined in RFC 4862."/>
        </Member>
        <Member Name="Tentative">
          <Annotation Term="OData.Description"
                      String="This address is currently undergoing Duplicate Address Detection testing as defined in RFC 4862 section 5.4."/>
        </Member>
        <Member Name="Failed">
          <Annotation Term="OData.Description"
                      String="This address has failed Duplicate Address Detection testing as defined in RFC 4862 section 5.4 and is not currently in use."/>
        </Member>
      </EnumType>

      <ComplexType Name="IPv6StaticAddress" BaseType="IPAddresses.IPv6StaticAddress">
        <Annotation Term="OData.Description"
                    String="This object represents a single IPv6 static address to be assigned on a network interface."/>
        <Annotation Term="OData.AdditionalProperties" Bool="false"/>
        <Property Name="Oem" Type="Resource.Oem" Nullable="false"/>
        <Property Name="Address" Type="Edm.String">
          <Annotation Term="OData.Description" String="A valid IPv6 address."/>
          <Annotation Term="OData.LongDescription"
                      String="This property provides access to a static IPv6 address that is currently assigned on a network interface."/>
        ...
        <Property Name="PrefixLength" Type="IPAddresses.v1_0_0.PrefixLength">
          ...
          <Annotation Term="OData.LongDescription"
                      String="Provides the IPv6 network prefix length in bits for this address."/>
          <Annotation Term="Redfish.Required"/>
        </Property>
      </ComplexType>
...
#endif /* PSME_REST_METADATA_I_PADDRESSES_HPP */
