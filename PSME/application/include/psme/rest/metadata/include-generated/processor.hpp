#ifndef PSME_REST_METADATA_PROCESSOR_HPP
#define PSME_REST_METADATA_PROCESSOR_HPP
...
static const std::string Processor_XML =
  ...
  <edmx:DataServices>
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="Processor">
      ...
      <EntityType Name="Processor" BaseType="Resource.v1_0_0.Resource" Abstract="true">
        <Annotation Term="OData.Description"
                    String="The Processor resource reports information about a single processor contained within a system.  This includes both performance characteristics (clock speed, architecture, core count, etc.) and compatibility (e.g. CPU ID instruction results)."/>
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="Processor.v1_0_0">
      ...
      <EntityType Name="Processor" BaseType="Processor.Processor">
        <Annotation Term="OData.Description"
                    String="This is the schema definition for the Processor resource.  It represents the properties of a processor attached to a System."/>
        <Annotation Term="OData.AdditionalProperties" Bool="false"/>
        <Property Name="Socket" Type="Edm.String">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This property shall contain the string which identifies the physical location or socket of the processor."/>
        </Property>
        <Property Name="ProcessorType" Type="Processor.v1_0_0.ProcessorType">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This property shall contain the string which identifies the type of processor contained in this Socket."/>
        </Property>
        <Property Name="ProcessorArchitecture" Type="Processor.v1_0_0.ProcessorArchitecture">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This property shall contain the string which identifies the architecture of the processor contained in this Socket."/>
        </Property>
        <Property Name="InstructionSet" Type="Processor.v1_0_0.InstructionSet">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This property shall contain the string which identifies the instruction set of the processor contained in this socket."/>
        </Property>
        <Property Name="ProcessorId" Type="Processor.v1_0_0.ProcessorId" Nullable="false">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This object shall contain identification information for this processor."/>
        </Property>
        ...
        <Property Name="Manufacturer" Type="Edm.String">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This property shall contain a string which identifies the manufacturer of the processor."/>
        </Property>
        <Property Name="Model" Type="Edm.String">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description" String="The product model number of this device."/>
          <Annotation Term="OData.LongDescription"
                      String="This property shall indicate the model information as provided by the manufacturer of this processor."/>
        </Property>
        <Property Name="MaxSpeedMHz" Type="Edm.Int64">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This property shall indicate the maximum rated clock speed of the processor in MHz."/>
        </Property>
        <Property Name="TotalCores" Type="Edm.Int64">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This property shall indicate the total count of independent processor cores contained within this processor."/>
        </Property>
        <Property Name="TotalThreads" Type="Edm.Int64">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description"
                      String="The total number of execution threads supported by this processor"/>
          <Annotation Term="OData.LongDescription"
                      String="This property shall indicate the total count of independent execution threads supported by this processor."/>
        </Property>
      </EntityType>
      ...
      <ComplexType Name="ProcessorId">
        ...
        <Property Name="VendorId" Type="Edm.String">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This property shall indicate the Vendor Identification string information as provided by the manufacturer of this processor."/>
        </Property>
        <Property Name="IdentificationRegisters" Type="Edm.String">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This property shall include the raw CPUID instruction output as provided by the manufacturer of this processor."/>
        </Property>
        <Property Name="EffectiveFamily" Type="Edm.String">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This property shall indicate the effective Family information as provided by the manufacturer of this processor."/>
        </Property>
        <Property Name="EffectiveModel" Type="Edm.String">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This property shall indicate the effective Model information as provided by the manufacturer of this processor."/>
        </Property>
        <Property Name="Step" Type="Edm.String">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description" String="The Step value for this processor."/>
          <Annotation Term="OData.LongDescription"
                      String="This property shall indicate the Step or revision string information as provided by the manufacturer of this processor."/>
        </Property>
        <Property Name="MicrocodeInfo" Type="Edm.String">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This property shall indicate the Microcode Information as provided by the manufacturer of this processor."/>
        </Property>
      </ComplexType>
...
#endif /* PSME_REST_METADATA_PROCESSOR_HPP */
