#ifndef PSME_REST_METADATA_RESOURCE_HPP
#define PSME_REST_METADATA_RESOURCE_HPP
...
static const std::string Resource_XML =
  ...
  <edmx:DataServices>
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="Resource">
      ...
      <TypeDefinition Name="Id" UnderlyingType="Edm.String">
        <Annotation Term="OData.Description"
                    String="Uniquely identifies the resource within the collection of like resources."/>
        <Annotation Term="OData.LongDescription"
                    String="This property represents an identifier for the resource.  All values for resources described by this schema shall comply to the requirements as described in the Redfish specification."/>
      </TypeDefinition>
      ...
      <TypeDefinition Name="Description" UnderlyingType="Edm.String">
        ...
        <Annotation Term="OData.LongDescription"
                    String="This object represents the Description property.  All values for resources described by this schema shall comply to the requirements as described in the Redfish specification."/>
      </TypeDefinition>
      ...
      <ComplexType Name="Oem">
        ...
        <Annotation Term="OData.Description" String="Oem extension object."/>
        <Annotation Term="OData.LongDescription"
                    String="This object represents the Oem properties.  All values for resources described by this schema shall comply to the requirements as described in the Redfish specification."/>
      </ComplexType>
      ...
      <ComplexType Name="OemObject">
        ...
        <Annotation Term="OData.LongDescription"
                    String="This object represents the base type for an Oem property.  All values for resources described by this schema shall comply to the requirements as described in the Redfish specification."/>
      </ComplexType>
      ...
      <EntityType Name="Item" BaseType="Resource.ItemOrCollection" Abstract="true">
        ...
        <Property Name="Oem" Type="Resource.Oem" Nullable="false">
          <Annotation Term="OData.Description"
                      String="This is the manufacturer/provider specific extension moniker used to divide the Oem object into sections."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of this string shall be of the format for the reserved word *Oem*."/>
        </Property>
      </EntityType>
      ...
      <EnumType Name="State">
        ...
        <Member Name="Deferring">
          <Annotation Term="OData.Description"
                      String="The element will not process any commands but will queue new requests."/>
        </Member>
        <Member Name="Quiesced">
          <Annotation Term="OData.Description"
                      String="The element is enabled but only processes a restricted set of commands."/>
        </Member>
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="Resource.v1_1_0">
      ...
      <ComplexType Name="Location" BaseType="Resource.Location">
        ...
        <Property Name="Oem" Type="Resource.Oem" Nullable="false">
          <Annotation Term="OData.Description" String="This property shall represent OEM extensions."/>
      ...
      <EnumType Name="DurableNameFormat">
        <Member Name="NAA">
          ...
          <Annotation Term="OData.LongDescription" String="This durable name is a hexadecimal representation of the Name Address Authority structure as defined in the T11 Fibre Channel* Framing and Signaling 3 (FC-FS-3) Specification."/>
        </Member>
        <Member Name="iQN">
          <Annotation Term="OData.Description" String="iSCSI Qualified Name."/>
          <Annotation Term="OData.LongDescription" String="This durable name is in the iSCSI Qualified Name format as defined in RFC 3720 and RFC 3721."/>
        </Member>
        <Member Name="FC_WWN">
          <Annotation Term="OData.Description" String="Fibre Channel World Wide Name."/>
          <Annotation Term="OData.LongDescription" String="This durable name is a hexadecimal representation of the World Wide Name format as defined in the T11 Fibre Channel Physical and Signaling Interface Specification."/>
        </Member>
        <Member Name="UUID">
          <Annotation Term="OData.Description" String="Universally Unique Identifier."/>
          <Annotation Term="OData.LongDescription" String="This durable name is the hexadecimal representation of the Universal Unique Identifier as defined in the Internation Telecom Union* OSI networking and system aspects Naming, Addressing, and Registration Specification."/>
        </Member>
        <Member Name="EUI">
          <Annotation Term="OData.Description" String="IEEE-defined 64-bit Extended Unique Identifier."/>
          <Annotation Term="OData.LongDescription" String="This durable name is the hexadecimal representation of the IEEE*-defined 64-bit Extended Unique Identifier as defined in the IEEE Guidelines for 64-bit Global Identifier (EUI-64) Specification."/>
        </Member>
        <Member Name="NQN">
          <Annotation Term="OData.Description" String="NVMe Qualified Name."/>
          <Annotation Term="OData.LongDescription" String="This durable name is in the NVMe Qualified Name format as defined in the NVN Express* over Fabric Specification."/>
        </Member>
        <Member Name="NSID">
          <Annotation Term="OData.Description" String="NVM Namespace Identifier."/>
          <Annotation Term="OData.LongDescription" String="This durable name is in the NVM Namespace Identifier format as defined in the NVN Express Specification."/>
        </Member>
        <Member Name="SystemPath">
          <Annotation Term="OData.Description" String="SystemPath."/>
          <Annotation Term="OData.LongDescription"
                      String="The operating system path to resource."/>
        </Member>
        <Member Name="LUN">
          <Annotation Term="OData.Description" String="Logical Unit Number."/>
          <Annotation Term="OData.LongDescription"
                      String="Logical Unit Number (LUN) of device. Used in iSCSI protocol to enumerate volumes."/>
        </Member>
      </EnumType>
...
#endif /* PSME_REST_METADATA_RESOURCE_HPP */
