#ifndef PSME_REST_METADATA_SIMPLE_STORAGE_HPP
#define PSME_REST_METADATA_SIMPLE_STORAGE_HPP
...
static const std::string SimpleStorage_XML =
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="SimpleStorage">
      ...
      <EntityType Name="SimpleStorage" BaseType="Resource.v1_0_0.Resource" Abstract="true">
        <Annotation Term="OData.Description"
                    String="This is the schema definition for the Simple Storage resource.  It represents the properties of a storage controller and its directly-attached devices."/>
      </EntityType>
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="SimpleStorage.v1_0_0">
      ...
      <EntityType Name="SimpleStorage" BaseType="SimpleStorage.SimpleStorage">
        ...
        <Property Name="UefiDevicePath" Type="Edm.String">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This property shall contain the UEFI device path used to identify and locate the specific storage controller"/>
        </Property>
        <Property Name="Devices" Type="Collection(SimpleStorage.v1_0_0.Device)" Nullable="false">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This property shall contain a list of storage devices associated with this resource"/>
        </Property>
      ...
      <ComplexType Name="Device">
        ...
        <Property Name="Manufacturer" Type="Edm.String">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This property shall indicate the name of the manufacturer of this storage device."/>
        </Property>
        <Property Name="Model" Type="Edm.String">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description" String="The product model number of this device."/>
          <Annotation Term="OData.LongDescription"
                      String="This property shall indicate the model information as provided by the manufacturer of this storage device."/>
        </Property>
      </ComplexType>
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="SimpleStorage.v1_1_0">
      ...
      <ComplexType Name="Device" BaseType="SimpleStorage.v1_0_0.Device">
        <Property Name="CapacityBytes" Type="Edm.Int64">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall represent the size (in bytes) of the Storage Device."/>
...
#endif /* PSME_REST_METADATA_SIMPLE_STORAGE_HPP */
