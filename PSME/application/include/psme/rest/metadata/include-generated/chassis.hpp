#ifndef PSME_REST_METADATA_CHASSIS_HPP
#define PSME_REST_METADATA_CHASSIS_HPP
...
static const std::string Chassis_XML =
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="Chassis.v1_0_0">
      ...
      <EntityType Name="Chassis" BaseType="Chassis.Chassis">
        ...
        <Property Name="SKU" Type="Edm.String">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be the stock-keeping unit number for this chassis."/>
        </Property>
        ...
        <Property Name="IndicatorLED" Type="Resource.v1_1_0.IndicatorLED">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This value of this property shall contain the indicator light state for the indicator light associated with this system."/>
        </Property>
        ...
        <NavigationProperty Name="Thermal" Type="Thermal.Thermal" ContainsTarget="true" Nullable="false">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description"
                      String="A reference to the thermal properties (fans, cooling, sensors) for this chassis."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be a reference to the resource that represents the thermal characteristics of this chassis and shall be of type Thermal."/>
          <Annotation Term="OData.AutoExpandReferences"/>
        </NavigationProperty>
        <NavigationProperty Name="Power" Type="Power.Power" ContainsTarget="true" Nullable="false">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description"
                      String="A reference to the power properties (power supplies, power policies, sensors) for this chassis."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be a reference to the resource that represents the power characteristics of this chassis and shall be of type Power."/>
          <Annotation Term="OData.AutoExpandReferences"/>
        </NavigationProperty>
      </EntityType>
      ...
      <ComplexType Name="Links" BaseType="Resource.Links">
        <NavigationProperty Name="ComputerSystems" Type="Collection(ComputerSystem.ComputerSystem)" Nullable="false">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description"
                      String="An array of references to the computer systems contained in this chassis.  This will only reference ComputerSystems that are directly and wholly contained in this chassis."/>
          <Annotation Term="OData.LongDescription"
        ...
        <NavigationProperty Name="ManagedBy" Type="Collection(Manager.Manager)" Nullable="false">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description"
                      String="An array of references to the Managers responsible for managing this chassis."/>
          <Annotation Term="OData.LongDescription"
        ...
        <NavigationProperty Name="ContainedBy" Type="Chassis.Chassis" Nullable="false">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be a reference to the resource that represents the chassis that contains this chassis and shall be of type Chassis."/>
          <Annotation Term="OData.AutoExpandReferences"/>
        </NavigationProperty>
        ...
        <NavigationProperty Name="PoweredBy" Type="Collection(Resource.Item)" Nullable="false">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description"
                      String="An array of ID[s] of resources that power this chassis. Normally the ID will be a chassis or a specific set of powerSupplies"/>
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be an array of IDs containing pointers consistent with JSON pointer syntax to the resource that powers this chassis."/>
          <Annotation Term="OData.AutoExpandReferences"/>
        </NavigationProperty>
        <NavigationProperty Name="CooledBy" Type="Collection(Resource.Item)" Nullable="false">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description"
                      String="An array of ID[s] of resources that cool this chassis. Normally the ID will be a chassis or a specific set of fans."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be an array of IDs containing pointers consistent with JSON pointer syntax to the resource that cools this chassis."/>
          <Annotation Term="OData.AutoExpandReferences"/>
        </NavigationProperty>
      </ComplexType>
      ...
      <ComplexType Name="Actions">
        ...
        <Property Name="Oem" Type="Chassis.v1_0_0.OemActions" Nullable="false">
          <Annotation Term="OData.Description" String="Representation of OEM extensions"/>
          <Annotation Term="OData.LongDescription" String="This property shall represent OEM extensions."/>
        </Property>
      </ComplexType>
      ...
      <EnumType Name="ChassisType">
        <Member Name="Blade">
          ...
          <Annotation Term="OData.LongDescription" String="An enclosed or semi-enclosed, typically vertically oriented, system chassis that must be plugged into a multi-system chassis to function normally."/>
        </Member>
        <Member Name="Card">
          <Annotation Term="OData.Description"
                      String="A loose device or circuit board intended to be installed in a system or other enclosure"/>
          <Annotation Term="OData.LongDescription" String="A loose device or circuit board intended to be installed in a system or other enclosure."/>
        </Member>
        <Member Name="Cartridge">
          <Annotation Term="OData.Description"
                      String="A small self-contained system intended to be plugged into a multi-system chassis"/>
          <Annotation Term="OData.LongDescription" String="A small self-contained system intended to be plugged into a multi-system chassis."/>
        </Member>
        <Member Name="Component">
          <Annotation Term="OData.Description"
                      String="A small chassis, card, or device which contains devices for a particular subsystem or function"/>
          <Annotation Term="OData.LongDescription" String="A small chassis, card, or device that contains devices for a particular subsystem or function."/>
        </Member>
        <Member Name="Drawer">
          <Annotation Term="OData.Description"
          ...
          <Annotation Term="OData.LongDescription" String="An enclosed or semi-enclosed, typically horizontally oriented, system chassis that may be slid into a multi-system chassis."/>
        </Member>
        <Member Name="Enclosure">
          <Annotation Term="OData.Description"
                      String="A generic term for a chassis that does not fit any other description"/>
          <Annotation Term="OData.LongDescription" String="A generic term for a chassis that does not fit any other description."/>
        </Member>
        <Member Name="Expansion">
          <Annotation Term="OData.Description"
                      String="A chassis which expands the capabilities or capacity of another chassis"/>
          <Annotation Term="OData.LongDescription" String="A chassis that expands the capabilities or capacity of another chassis."/>
        </Member>
        <Member Name="IPBasedDrive">
          <Annotation Term="OData.Description"
                      String="A chassis in a drive form factor with IP-based network connections."/>
          <Annotation Term="OData.LongDescription" String="A chassis in a drive form factor IP-based network connections."/>
        </Member>
        <Member Name="Module">
          <Annotation Term="OData.Description"
                      String="A small, typically removable, chassis or card which contains devices for a particular subsystem or function"/>
          <Annotation Term="OData.LongDescription" String="A small, typically removable, chassis or card that contains devices for a particular subsystem or function."/>
        </Member>
        <Member Name="Other">
          <Annotation Term="OData.Description" String="A chassis that does not fit any of these definitions."/>
          <Annotation Term="OData.LongDescription" String="A chassis that does not fit any of the other definitions."/>
        </Member>
        <Member Name="Pod">
          <Annotation Term="OData.Description"
                      String="A collection of equipment racks in a large, likely transportable, container"/>
          <Annotation Term="OData.LongDescription" String="A collection of equipment racks in a large, likely transportable, container."/>
        </Member>
        <Member Name="Rack">
          <Annotation Term="OData.Description" String="An equipment rack, typically a 19-inch wide freestanding unit."/>
          <Annotation Term="OData.LongDescription" String="An equipment rack, typically a 19-inch wide freestanding unit."/>
        </Member>
        <Member Name="RackGroup">
          ...
          <Annotation Term="OData.LongDescription" String="A group of racks that form a single entity or share infrastructure."/>
        </Member>
        <Member Name="RackMount">
          <Annotation Term="OData.Description"
                      String="A single system chassis designed specifically for mounting in an equipment rack"/>
          <Annotation Term="OData.LongDescription" String="A single system chassis designed specifically for mounting in an equipment rack."/>
        </Member>
        <Member Name="Row">
          <Annotation Term="OData.Description" String="A collection of equipment racks."/>
          <Annotation Term="OData.LongDescription" String="A collection of equipment racks."/>
        </Member>
        <Member Name="Shelf">
          <Annotation Term="OData.Description"
          ...
          <Annotation Term="OData.LongDescription" String="An enclosed or semi-enclosed, typically horizontally oriented, system chassis that must be plugged into a multi-system chassis to function normally."/>
        </Member>
        <Member Name="Sidecar">
          <Annotation Term="OData.Description"
                      String="A chassis that mates mechanically with another chassis to expand its capabilities or capacity"/>
          <Annotation Term="OData.LongDescription" String="A chassis that mates mechanically with another chassis to expand its capabilities or capacity."/>
        </Member>
        <Member Name="Sled">
          <Annotation Term="OData.Description"
          ...
          <Annotation Term="OData.LongDescription" String="An enclosed or semi-enclosed system chassis that must be plugged into a multi-system chassis to function normally similar to a blade type chassis."/>
        </Member>
        <Member Name="StandAlone">
          <Annotation Term="OData.Description"
                      String="A single, free-standing system, commonly called a tower or desktop chassis"/>
          <Annotation Term="OData.LongDescription" String="A single freestanding system, commonly called a tower or desktop chassis."/>
        </Member>
        <Member Name="Zone">
          <Annotation Term="OData.Description"
          ...
          <Annotation Term="OData.LongDescription" String="A logical division or portion of a physical chassis that contains multiple devices or systems that cannot be physically separated."/>
        </Member>
      </EnumType>
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="Chassis.v1_0_1">
      ...
      <EntityType Name="Chassis" BaseType="Chassis.v1_0_0.Chassis">
        <Property Name="PowerState" Type="Chassis.v1_0_1.PowerState">
          ...
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall contain the power state of the chassis."/>
        </Property>
      </EntityType>
      ...
      <EnumType Name="PowerState">
        ...
        <Member Name="Off">
          <Annotation Term="OData.Description"
                      String="The components within the chassis has no power, except some components may continue to have AUX power such as management controller."/>
        </Member>
        <Member Name="PoweringOn">
          <Annotation Term="OData.Description"
                      String="A temporary state between Off and On. The components within the chassis can take time to process the power on action."/>
        </Member>
        <Member Name="PoweringOff">
          <Annotation Term="OData.Description"
                      String="A temporary state between On and Off. The components within the chassis can take time to process the power off action."/>
        </Member>
      </EnumType>
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="Chassis.v1_1_0">
      ...
      <EntityType Name="Chassis" BaseType="Chassis.v1_0_2.Chassis">
        <Property Name="PhysicalSecurity" Type="Chassis.v1_1_0.PhysicalSecurity" Nullable="false">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This value of this property shall contain the sensor state of the physical security."/>
        </Property>
      </EntityType>
      ...
      <ComplexType Name="PhysicalSecurity">
        ...
        <Property Name="IntrusionSensorNumber" Type="Edm.Int64">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description"
                      String="A numerical identifier to represent the physical security sensor."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall be a numerical identifier for this physical security sensor that is unique within this resource. "/>
        </Property>
        <Property Name="IntrusionSensor" Type="Chassis.v1_1_0.IntrusionSensor">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/ReadWrite"/>
          <Annotation Term="OData.Description"
                      String="This indicates the known state of the physical security sensor, such as if it is hardware intrusion detected."/>
          <Annotation Term="OData.LongDescription"
        ...
        <Property Name="IntrusionSensorReArm" Type="Chassis.v1_1_0.IntrusionSensorReArm">
          ...
          <Annotation Term="OData.LongDescription"
                      String="This property shall represent the method to set back to the Normal statue of this physical security sensor.  Manual indicates manual re-arm is needed.  Automatic indicates the state is restored automatically as no abnormal physical security conditions are detected."/>
        </Property>
      </ComplexType>
      ...
      <EnumType Name="IntrusionSensor">
        <Member Name="Normal">
          <Annotation Term="OData.Description"
                      String="No abnormal physical security conditions are detected at this time."/>
        </Member>
        <Member Name="HardwareIntrusion">
          <Annotation Term="OData.Description"
                      String="A door, lock, or other mechanism protecting the internal system hardware from being accessed is detected as being in an insecure state."/>
        </Member>
      ...
      <EnumType Name="IntrusionSensorReArm">
        <Member Name="Manual">
          <Annotation Term="OData.Description"
                      String="This sensor would be restored to the Normal state by a manual re-arm."/>
        </Member>
        <Member Name="Automatic">
          <Annotation Term="OData.Description"
                      String="This sensor would be restored to the Normal state automatically as no abnormal physical security conditions are detected."/>
        </Member>
      </EnumType>
    </Schema>
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="Chassis.v1_2_0">
      <EntityType Name="Chassis" BaseType="Chassis.v1_1_2.Chassis">
        <Property Name="Location" Type="Resource.v1_1_0.Location" Nullable="false">
          <Annotation Term="OData.Description" String="Location of a resource"/>
          <Annotation Term="OData.LongDescription"
                      String="This type shall describe the location of a resource."/>
      ...
      <ComplexType Name="Links" BaseType="Chassis.v1_0_0.Links">
        <NavigationProperty Name="ManagersInChassis" Type="Collection(Manager.Manager)">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description"
                      String="An array of references to the managers located in this Chassis."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall reference one or more resources of type Manager that are in this Chassis."/>
          <Annotation Term="OData.AutoExpandReferences"/>
        </NavigationProperty>
        <NavigationProperty Name="Drives" Type="Collection(Drive.Drive)">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description"
                      String="An array of references to the disk drives located in this Chassis."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall reference one or more resources of type Drive that are in this Chassis."/>
          <Annotation Term="OData.AutoExpandReferences"/>
        </NavigationProperty>
        <NavigationProperty Name="Storage" Type="Collection(Storage.Storage)">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description"
                      String="An array of references to the storage subsystems connected to or inside this Chassis."/>
          <Annotation Term="OData.LongDescription"
                      String="The value of this property shall reference one or more resources of type Storage that are connected to or contained inside this Chassis."/>
          <Annotation Term="OData.AutoExpandReferences"/>
        </NavigationProperty>
      </ComplexType>
    </Schema>
...
#endif /* PSME_REST_METADATA_CHASSIS_HPP */
