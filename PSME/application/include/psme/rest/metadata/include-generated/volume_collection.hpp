#ifndef PSME_REST_METADATA_VOLUME_COLLECTION_HPP
#define PSME_REST_METADATA_VOLUME_COLLECTION_HPP
...
static const std::string VolumeCollection_XML =
  ...
  <edmx:DataServices>
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="VolumeCollection">
      ...
      <EntityType Name="VolumeCollection" BaseType="Resource.v1_0_0.ResourceCollection">
        ...
        <NavigationProperty Name="Members" Type="Collection(Volume.Volume)" Nullable="false">
          <Annotation Term="OData.Permissions" EnumMember="OData.Permission/Read"/>
          <Annotation Term="OData.Description" String="Contains the members of this collection."/>
          <Annotation Term="OData.LongDescription" String="Colletion of storage resource instances."/>
...
#endif /* PSME_REST_METADATA_VOLUME_COLLECTION_HPP */
