#ifndef PSME_REST_METADATA_NETWORK_DEVICE_FUNCTION_COLLECTION_HPP
#define PSME_REST_METADATA_NETWORK_DEVICE_FUNCTION_COLLECTION_HPP
...
static const std::string NetworkDeviceFunctionCollection_XML =
  ...
  <edmx:DataServices>
    ...
    <Schema xmlns="http://docs.oasis-open.org/odata/ns/edm" Namespace="NetworkDeviceFunctionCollection">
      ...
      <EntityType Name="NetworkDeviceFunctionCollection" BaseType="Resource.v1_0_0.ResourceCollection">
        ...
        <NavigationProperty Name="Members" Type="Collection(NetworkDeviceFunction.NetworkDeviceFunction)" Nullable="false">
...
#endif /* PSME_REST_METADATA_NETWORK_DEVICE_FUNCTION_COLLECTION_HPP */
